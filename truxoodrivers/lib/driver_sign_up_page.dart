...
class _DriverRegistrationPageState extends State<DriverRegistrationPage> {
  ...
  Map<String, dynamic> _getImageSettings(String imageType) {
    switch (imageType) {
      ...
      case 'driver':
        return {'maxWidth': 800.0, 'maxHeight': 800.0, 'quality': 70};
      case 'truck':
        return {'maxWidth': 600.0, 'maxHeight': 600.0, 'quality': 60};
      default:
        return {'maxWidth': 800.0, 'maxHeight': 800.0, 'quality': 70};
    }
  }
  ...
  Widget _buildImagePickerSection(
      String title, File? image, String imageType) {
    return Column(
