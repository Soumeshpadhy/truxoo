...
class _LoginState extends State<Login> with TickerProviderStateMixin {
  ...
  Future<bool> sendPhoneNumberToBackend(String phoneNumber) async {
    ...
    // iOS simulator: http://localhost:3000/api/send-otp
    // Real device (LAN): http://YOUR_PC_LAN_IP:3000/api/send-otp
    // Real device + adb reverse: http://localhost:3000/api/send-otp
    final url = Uri.parse('http://10.0.2.2:3000/api/send-otp');
    ...
    try {
      ...
      debugPrint('POST /api/send-otp - status: ${response.statusCode}, body: ${response.body}');
      return response.statusCode == 200;
    } catch (e) {
      debugPrint('Error sending phone number: $e');
      return false;
    }
  }
...
// Phone formatter class (unchanged)
